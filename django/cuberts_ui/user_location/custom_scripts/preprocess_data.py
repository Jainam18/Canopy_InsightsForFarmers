...
def preprocess_lat_long_data(lat, long, area):
    ...
    file_pattern_1 = r"C:\Jinang's Collection\Hackathons\NASA Spaceapps\nasa-space-apps-cuberts\django\cuberts_ui\data\GW_SM/*.nc4"
    file_pattern_2 = r"C:\Jinang's Collection\Hackathons\NASA Spaceapps\nasa-space-apps-cuberts\django\cuberts_ui\data\GW_SM/*.nc4"
    file_pattern_3 = r"C:\Jinang's Collection\Hackathons\NASA Spaceapps\nasa-space-apps-cuberts\django\cuberts_ui\data\GW_SM/*.nc4"
    file_pattern_4 = r"C:\Jinang's Collection\Hackathons\NASA Spaceapps\nasa-space-apps-cuberts\django\cuberts_ui\data\GW_SM/*.nc4"


    file_pattern = [file_pattern_1, file_pattern_2, file_pattern_3, file_pattern_4]



    def inter_process(file_pattern, divisor):
        ...
        for idx, file in enumerate(file_list):
            ...
            with h5py.File(file, 'r') as file:
                ...
                groundwater_data = np.where(groundwater_data == -999, np.nan,
                                            groundwater_data)  # Replace missing values with NaN
            ...
            if groundwater_data.size == 0 or np.isnan(groundwater_data).all():
                print(
                    "Error: No valid data found for the specified location and area size. Please check the input coordinates and area size.")
            else:
                '''
